...
# Constants
# Use only one 'models' directory, not nested
if len(sys.argv) < 3:
    print("Usage: efnetv2s_download_quant.py <model_name> <models_path>")
    sys.exit(1)
MODEL_NAME = sys.argv[1]
MODELS_PATH = Path(sys.argv[2])
PRECISIONS = ["FP32", "FP16"]

BASE_DIR = MODELS_PATH / "object_classification" / MODEL_NAME
...
def quantize_model():
    ...
    # Balanced approach: 600 images for good accuracy with reasonable time
    calibration_size = 600
