...
CLASS_IDS="" # YOLOv8 classes to be detected example "0,1,30"
...
gvametapublish method=mqtt file-format=2 address=127.0.0.1:1883 mqtt-client-id=yolov8 topic=event/detection ! \
queue ! \
